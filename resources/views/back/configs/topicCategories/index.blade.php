    ...
    <div class="col-8">
      <div class="px-3 py-3 bg-white rounded-3">
        <ul class="nav nav-tabs">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#">话题分类配置</a>
          </li>
          </li>
        </ul>
        @if (count($topicCategories))
        ...
        <div class="mt-3">
          {{ $topicCategories->appends($filters)->render() }}
        </div>
        @else
    ...
    <div class="col-2">
      <div class="card mb-3 border-0">
        <div class="card-body">
          ...
          <a class="btn btn-primary w-100" href="{{ route('back.configs.topicCategories.create') }}">
            新增话题分类
          </a>
        </div>
      </div>
      <div class="card border-0">
        <div class="card-body pt-2">
          ...
          <hr class="mt-2 mb-3">
          <form action="{{ route('back.configs.topicCategories.index') }}" method="GET" class="search-form">
            <div class="mb-3">
              <label for="search" class="form-label">话题分类名称</label>
              <input name="search" type="text" class="form-control bg-white" id="search" placeholder="话题分类名称">
            </div>
